...
H3_DEFINE_COMPONENT_PROPERTY_ACCESSORS_RW(TextComponent, SH3TextProperties, Props);
H3_DEFINE_COMPONENT_PROPERTY_ACCESSORS_RW_EX(TextComponent, TEXTCOMPONENT_TYPEID, const char*, Text);
H3_DEFINE_COMPONENT_PROPERTY_ACCESSORS_RW_EX(TextComponent, TEXTCOMPONENT_TYPEID, SH3TextProperties, Props);