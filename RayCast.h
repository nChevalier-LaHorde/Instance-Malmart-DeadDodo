...
#define RAYCASTCOMPONENT_TYPEID 0x0025202221
...
#define RAYCASTCOMPONENT_CREATE(ZOMBIE)                                          \
	(SH3Component) {                                                            \
		.Init               = NULL,                                                      \
		.Terminate          = RayCastComponent_Terminate,                                 \
		.Update             = UpR,                                                      \
		.isInitialized      = false,                                                     \
		.OnCollisionEnter   = ColR,														\
		.componentType      = RAYCASTCOMPONENT_TYPEID,									 \
		.properties         = RayCastComponent_CreateProperties(ZOMBIE) \
	}
